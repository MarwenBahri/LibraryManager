	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <select id="id" name="id" class="browser-default">
	              <c:choose>
	                <c:when test="${chosen == true}">
	                    <option value=${chosenEmprunt.id}>"${chosenEmprunt.livre.titre}", emprunte par ${chosenEmprunt.membre.prenom} ${chosenEmprunt.membre.nom}</option>
                    </c:when>
                    <c:otherwise>
                  ...
                  <option value=${emprunt.id}>"${emprunt.livre.titre}", emprunte par ${emprunt.membre.prenom} ${emprunt.membre.nom}</option>
