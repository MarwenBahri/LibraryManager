  ...
  <main>
    <section class="content">
      ...
      <h5>Suppression du membre n ${membre.id}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
          <p>etes-vous sur de vouloir supprimer la fiche de "${membre.prenom}" "${membre.nom}" ?</p> <!-- TODO : remplacer prenomDuMembre et nomDuMembre par les valeurs correspondantes -->
